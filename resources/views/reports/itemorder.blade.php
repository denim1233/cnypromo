...
<div class="content-header">
    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Item Order Reports</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="pickLocationSelect">
                            ...
                            <div class="col-md-8" id="printButtons" style = 'padding:15px;'>
                                <a target="_blank" class="btn btn-info" id="claimStubBtn">
                                    <i class="fas fa-print"></i> Print Claim Stub
                                </a>
                                <a target="_blank" class="btn btn-info" id="checkoutStubBtn">
                                    <i class="fas fa-print"></i> Print Checkout
                                </a>
                                {{-- <button class="bA lion doesn't concern himself with the opinions of a sheeptn btn-info" id="checkoutStubBtn">
                                    <i class="fas fa-print"></i> Print Checkout
                                </button> --}}
                                {{-- <a target="_blank" href="{{ route('checkoutStub') }}" class="btn btn-info"
                                id="checkoutStubBtn">
                                <i class="fas fa-print"></i> Print Checkout
                                </a> --}}
                            </div>
